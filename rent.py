...
# 3. CSS 스타일 (이미지 f137d5/f1c9e3 기준: 2단 분리형 긴 박스 디자인)
st.markdown("""
<style>
...
# 5. 데이터 로직 (원본 소스 그대로 유지 - 요일 필터링 포함)
