...
# 2. CSS 스타일 (사진 image_e0f4e3.png 디자인 그대로)
st.markdown("""
<style>
...
# 5. 결과 출력 (사진 image_e0f4e3.png 완벽 재현)
            ...
            if not bu_df.empty:
                ...
                if not final_df.empty:
                    ...
                    for _, row in final_df.iterrows():
                        date_range = f"📅 {row['startDt']} ~ {row['endDt']}"
                        st.markdown(f"""
                        <div class="res-card">
                            ...
                            <div class="res-info" style="font-size:13px; color:#666;">🗓️ {date_range}</div>
