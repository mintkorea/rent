...
<style>
    ...
    div[data-testid="stHorizontalBlock"] div[data-testid="stColumn"] button { height: 30px !important; min-height: 30px !important; padding: 0px 10px !important; font-size: 13px !important; border-radius: 6px !important; background-color: white !important; border: 1px solid #D1D9E6 !important; }
</style>
...
if st.session_state.search_performed:
    ...
    # 슬림 버튼 (변경 시 세션 유지 및 즉시 반영)
    bc1, bc2, bc3, bc4, bc5 = st.columns([2, 0.4, 0.8, 0.4, 2])
    with bc2:
