...
<style>
    ...
    .building-header { 
        ...
        font-weight: bold; 
        color: #2E5077; 
        margin: 10px 0 3px 0 !important; /* 위 간격 10px로 축소 */
...
if search_clicked:
    ...
    # 결과 요약 헤더
    st.markdown(f'<div style="text-align:center; font-size:17px; font-weight:800; color:#1E3A5F; margin:15px 0 5px 0; padding:5px; border-bottom:1px solid #ddd;">🏢 대관 현황({target_date.strftime("%m/%d")})</div>', unsafe_allow_html=True)
