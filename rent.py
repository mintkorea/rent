...
if search_clicked:
    ...
    if not df_raw.empty:
        ...
        st.info("해당 날짜에 조회된 대관 내역이 없습니다.")    /* 요일 색상 */
...
# CSS 스타일 (원본 100% 유지 + 근무조 배지 스타일 포함)
st.markdown("""
<style>
    #top-anchor { position: absolute; top: 0; left: 0; }
    .block-container { padding: 1rem 1.2rem !important; max-width: 500px !important; }
    ...
    /* 결과 타이틀 디자인 */
    .date-display-box { 
        text-align: center; background-color: #F8FAFF; padding: 15px; border-radius: 12px; 
        margin-bottom: 20px; border: 1px solid #D1D9E6; line-height: 1.5;
    }
    .res-main-title { font-size: 20px; font-weight: 800; color: #1E3A5F; display: block; }
    .res-sub-title { font-size: 17px; font-weight: 700; color: #333; }
    ...
    .group-badge {
        ...
        font-weight: 800; color: white; margin-left: 3px;
    }
