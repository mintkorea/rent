...
# --- 세션 상태 및 URL 파라미터 동기화 (이동 기능 핵심) ---
if 'target_date' not in st.session_state:
    st.session_state.target_date = today_kst()
if 'search_performed' not in st.session_state:
    st.session_state.search_performed = True # 초기 화면부터 결과 표시
...
if st.session_state.search_performed:
    ...
    <div class="date-display-box">
        ...
        <span style="background-color:{shift['bg']}; color:white; padding:2px 10px; border-radius:15px; font-size:14px; margin-left:8px; vertical-align:middle; font-weight:bold;">근무 : {shift['name']}</span></span>
    </div>
