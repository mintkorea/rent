...
<style>
    ...
    /* 헤더 배경은 살짝 어둡게, 글씨는 테마에 따름 */
    th { background-color: rgba(128, 128, 128, 0.1); border: 1px solid #555; padding: 6px; font-size: 11px; font-weight: bold; }
    
    /* 셀 테두리 색상을 투명도가 있는 회색으로 설정하여 다크모드 대응 */
    td { border: 1px solid rgba(128, 128, 128, 0.3); padding: 8px 6px; font-size: 12px; text-align: center; }
</style>
""", unsafe_allow_html=True)

# 3. 데이터 로드 및 요일 필터링 함수 (성공 로직 유지)
