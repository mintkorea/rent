...
# CSS 스타일 (부타이틀, TOP 버튼, 요일 색상 완벽 복구)
st.markdown("""
<style>
    ...
    /* 부타이틀 스타일 */
    .sub-label { font-size: 18px !important; font-weight: 800; color: #2E5077; margin-top: 15px !important; display: block; margin-bottom: 8px !important; }
    ...
    .building-header { font-size: 19px !important; font-weight: bold; color: #2E5077; margin-top: 20px; border-bottom: 2px solid #2E5077; padding-bottom: 5px; margin-bottom: 12px; }
            ...
            for _, row in bu_df.iterrows():
                ...
                if show:
                    ...
                    <div class="event-card">
                        ...
                        <div style="font-size:14px; margin-top:4px; color:#333;">📄 {row['eventNm']}</div>
...
# CSS 스타일 (부타이틀 스타일 및 TOP 버튼 완벽 복구)
st.markdown("""
<style>
    #top-anchor { position: absolute; top: 0; left: 0; }
    .block-container { padding: 1rem 1.2rem !important; max-width: 500px !important; }
